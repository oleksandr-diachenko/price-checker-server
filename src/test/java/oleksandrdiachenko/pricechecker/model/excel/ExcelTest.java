...
class ExcelTest {
    ...
    void readExcelTest_oneField() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/oneField.xlsx"));
    ...
    void readExcelTest_oneField_Xls() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/oneField.xls"));
    ...
    void readExcelTest_twoField() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/twoField.xlsx"));
        assertEquals(
    ...
    void readExcelTest_oneField_withSpace() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/oneFieldWithSpace.xlsx"));
        assertEquals(
    ...
    void readExcelTest_twoField_different_size() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/twoFieldDifferentSizeFirstShorter.xlsx"));
        assertEquals(
    ...
    void readExcelTest_oneField_withSpaces_beginningAndMiddle() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/oneFieldSpacesAtBeginningAndAtMiddle.xlsx"));
        assertEquals(
    ...
    void readExcelTest_twoField_different_size2() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/twoFieldDifferentSizeSecondShorter.xlsx"));
        assertEquals(
    ...
    void readExcelTest_threeField_different_size() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/threeFieldDifferentSize.xlsx"));
        assertEquals(
                "[[SOT190003, 3760260451994, 50 ml, U], " +
                        "[SOT440001, 3760260453042], " +
    ...
    void readExcelTest_fiveSheets() throws IOException, InvalidFormatException {
        List<List<String>> table = excel.read(getFilePath("file/fiveSheets.xlsx"));
        assertEquals(
                "[[SBA030010, , 34], " +
                        "[SOT190003, 3760260451994, 50 ml, U, ], " +
                        "[SOT440001, 3760260453042, , , ], " +
